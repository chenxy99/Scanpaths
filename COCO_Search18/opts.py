...
def parse_opt():
    ...
    parser.add_argument("--vocabulary", type=str, default="./data/vocabulary", help="Directory to the saliency maps")
    ...
    parser.add_argument("--lambda_2", type=float, default=-1.0, help="Hyper-parameter for normalized scanpath saliency")
    parser.add_argument("--lambda_3", type=float, default=-2.0, help="Hyper-parameter for linear correlation coefficient")
    parser.add_argument("--lambda_4", type=float, default=10.0, help="Hyper-parameter for Kullback-Leibler divergence")
    parser.add_argument("--lambda_5", type=float, default=-2.0,
                        help="Hyper-parameter for mismatch scanpath in policy gradient update")
    parser.add_argument("--lambda_6", type=float, default=3.0,
                        help="Hyper-parameter for CC match loss")
